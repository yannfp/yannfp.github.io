			...
			<div className={styles.grid}>
				<div className={`reveal reveal-d1`}>
					...
					<p className={styles.text}>
						I'm a third-year engineering student at EPITA, specialising in
					...
					<p className={styles.text}>
						...
						built in 3 days. I'm particularly drawn to fullstack development —
						bridging low-level systems knowledge with modern web backends and
						interfaces.
					</p>
					<p className={styles.text}>
